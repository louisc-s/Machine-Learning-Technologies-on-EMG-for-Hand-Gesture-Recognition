...
from keras.layers import Dense, Conv1D, Flatten, MaxPooling1D,Dropout, BatchNormalization, Activation, LSTM, Bidirectional
...
for subject in subjects:
    ...
    #reshape data inputs to preferred CNN-LSTM configuration 
    ...
    #define optimised CNN-LSTM architecture 
    model = Sequential()
    ...
    #test CNN-LSTM again using model.predict function so that performance metrics can be generated 
